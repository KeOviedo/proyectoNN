function pruebaChart(accion,rootName){
  var data;
  fetch("../controller/test_charts_controller.php", {
      method: 'POST', 
      headers: {
...
console.log(data);
    ...
    function makeSeries(name, fieldName) {
      var series = chart.series.push(am5xy.ColumnSeries.new(root, {
        ...
        categoryXField: "nombre_ips"
      }));
    
      series.columns.template.setAll({
       
        tooltipText: "{nombre_ips}:{valueY}",
    ...
    makeSeries("Capita", "capita"); 
    makeSeries("Evento", "evento");
