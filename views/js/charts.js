...
function ColmunRotatedLabelsChart (accion ,rootName, seriesName, categoryName, valueX, textRange, initialRange, finalRange){
  var data;
  fetch("../controller/charts_controller.php", {
      method: 'POST', 
      headers: {
...
function dragOrderingBarChart(accion, rootName, categoryName, valueX, seriesName ){
  var data;
  fetch("../controller/charts_controller.php", {
      method: 'POST', 
      headers: {
...
function simplePieChart(accion, rootName, categoryName, valueX){
    var data;
  fetch("../controller/charts_controller.php", { 
    method: 'POST', 
      headers: {
 ...
 function gaugeChart(accion, rootName, startDate, finalDate){
    var data;
    fetch("../controller/charts_controller.php", {
        method: 'POST', 
        headers: {
